      ...
      <div className="homepage">
        <div className="personalPhoto">
          ...
          <div className="bolded">
            <span>B.S. Computer Science from <a href="https://www.emich.edu/" target="_blank">EMU</a></span><br/>
            <span>From Van Buren Township, MI, United States</span><br/>
            <span>Open to Remote, Hybrid, or In Person work</span><br/>
            <span>Full Stack Developer</span><br/>
            <span>STEM Educator</span><br/>
            <span>FLL Coach</span>
          </div>
          <h4>Social Links</h4>
